...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;1,300&display=swap"
        rel="stylesheet">
...
<body>
    <div id="app">
        ...
        <nav class="navbar navbar-dark sticky-top navbar-expand-md  p-0 flex-md-nowrap"
            style="background-color:{{ $empresa->navvar }};">
            <a class="navbar-brand nav-link text-white " href="{{ url('/') }}">

                <img src="{{ URL::asset('/img/logo.jpg') }}" alt="..."
                    class="border border-dark rounded-circle d-inline" style="width:50px;height:50px;">
                <h2 class="d-inline"><span
                        style="color:{{ $empresa->colletraenca }};">{{ $nombreEmpresa }}</span></h2>
                    ...
                    @if (auth()->user()->claseusr == 0)
                        ...
                        @if (Auth::user()->empresa_id > 0)
                            ...
                            <li class="text-right mr-3">
                                ...
                                <a href="#" class="estado-emp nav-link " data-type="select"
                                    data-pk="{{ Auth::user()->empresa_id }}"
                                    data-url="{{ url('/empresasestado/' . Auth::user()->empresa_id) }}"
                                    data-title="estado" data-value="{{ $estado }}" data-name="estado"
                                    style="color:{{ $empresa->colletramenu }};">
                                </a>
                            ...
                            <li class="{{ activeMenu('users*') }} inline text-right mr-3">
                                ...
                                <a href="{{ url('/notifications') }}" class="nav-link"
                                    style="color:{{ $empresa->colletramenu }};">Nuevo Pedido
                    ...
                    @if ($estado == 1)
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('login') }}"
                                style="color:{{ $empresa->colletramenu }};">{{ __('Iniciar Sesión') }}</a>
                        </li>
                    ...
                    @if (Route::has('register'))
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('register') }}"
                                style="color:{{ $empresa->colletramenu }};">{{ __('Registrar') }}</a>
                        </li>
                    @endif
                @else
                    ...
                    <li class="nav-item dropdown  text-right mr-3">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown"
                            style="background-color:{{ $empresa->navvar }};">
                            <a class="dropdown-item " style="color:{{ $empresa->colletramenu }};"
                                                    ...
                                                    @if ($estadoOrd != 'Aprobado')
                                                        <h4>
                                                            <a href="{{ url('/carrito') }}" class="nav-link text-white">
                                                                ...
                                                                <span
                                                                    class="badge badge-secondary badge-pill bg-light text-dark">
                                                                    {{ $articulosCount }}
                                                                </span>
                                                            </a>
                                                        </h4>
    ...
    <!-- MDB core JavaScript -->
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-material-design/0.3.0/js/material.min.js"></script>
    ...
    <!-- MDB core JavaScript -->
    <script type="text/javascript"
        src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-material-design/0.3.0/js/ripples.min.js"></script>
